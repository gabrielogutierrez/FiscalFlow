...
public class FiscalFlowDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        FiscalFlowGlobalFeatureConfigurator.Configure();
        FiscalFlowModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<FiscalFlowDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<FiscalFlowResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/FiscalFlow");

            options.DefaultResourceType = typeof(FiscalFlowResource);
        ...
        {
            options.MapCodeNamespace("FiscalFlow", typeof(FiscalFlowResource));
        });
    }
}
