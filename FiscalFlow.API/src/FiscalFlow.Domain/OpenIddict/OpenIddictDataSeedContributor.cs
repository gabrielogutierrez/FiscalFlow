...
namespace FiscalFlow.OpenIddict;
...
public class OpenIddictDataSeedContributor : OpenIddictDataSeedContributorBase, IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateScopesAsync()
    {
        ...
        {
            Name = "FiscalFlow", 
            DisplayName = "FiscalFlow API", 
            Resources = { "FiscalFlow" }
        });
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var appClientId = configurationSection["FiscalFlow_App:ClientId"];
        if (!appClientId.IsNullOrWhiteSpace())
        {
            var appClientRootUrl = configurationSection["FiscalFlow_App:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["FiscalFlow_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["FiscalFlow_Swagger:RootUrl"]?.TrimEnd('/');
